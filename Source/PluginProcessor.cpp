...
//==============================================================================
const juce::String BasicMBCompAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool BasicMBCompAudioProcessor::acceptsMidi() const
{
...
bool BasicMBCompAudioProcessor::producesMidi() const
{
...
bool BasicMBCompAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double BasicMBCompAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int BasicMBCompAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int BasicMBCompAudioProcessor::getCurrentProgram()
{
    return 0;
}

void BasicMBCompAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String BasicMBCompAudioProcessor::getProgramName (int index)
{
    return {};
}

void BasicMBCompAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void BasicMBCompAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void BasicMBCompAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool BasicMBCompAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void BasicMBCompAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    //auto invAPBlock = dsp::AudioBlock<float>(invAPBuffer);
    //auto invAPCtx = dsp::ProcessContextReplacing<float>(invAPBlock);
    ...
    if (compressor.bypassed->get())
    {
        ...
        {
            FloatVectorOperations::multiply(invAPBuffer.getWritePointer(ch), -1.f, numSamples);
        }
...
//==============================================================================
bool BasicMBCompAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* BasicMBCompAudioProcessor::createEditor()
{
    return new GenericAudioProcessorEditor(*this);
    //return new BasicMBCompAudioProcessorEditor (*this);
}

//==============================================================================
void BasicMBCompAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void BasicMBCompAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
AudioProcessorValueTreeState::ParameterLayout BasicMBCompAudioProcessor::createParameterLayout() {
...
{
    return new BasicMBCompAudioProcessor();
}
